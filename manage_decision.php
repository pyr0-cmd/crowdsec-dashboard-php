...
// Handle form submission for create and delete actions
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['create'])) {
        // Insert new record with automatic timestamps and default values
        ...
        // Prepare and execute the INSERT query using parameterized statements to prevent SQL injection
        ...
        $result = pg_query_params($dbconn, $insert_query, [
            ...
            $current_time,
            $current_time,
            $_POST['until'], // Assuming 'until' is provided by the user
            $type,
            $value,
            $scope
        ]);
